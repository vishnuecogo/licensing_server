  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'licensing': '0 4px 20px rgba(234, 179, 8, 0.15)',
      },
      spacing: {
        '18': '4.5rem',
        '88': '22rem',
